...
fig0 = plt.figure(0)
ax0 = fig0.add_subplot(111, autoscale_on=False, xlim=(0, 2000), ylim=(0, 50))
ax0.grid()
line0, = ax0.plot([], [], 'b+', lw=2)
line1, = ax0.plot([], [], 'r-', lw=2)
t01_text = ax0.text(0.02, 0.95, '', transform=ax0.transAxes)
